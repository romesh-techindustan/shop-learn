        ...
        <div className="adminModalBackdrop" onClick={onCancel}>
            ...
            >
                <div className="adminModalHeader">
                    ...
                    <button className="adminModalCloseBtn" onClick={onCancel}>✕</button>
                </div>
                ...
                <div className="adminModalFooter">
                    <button id="confirm-cancel-btn" className="adminBtn adminBtn--ghost" onClick={onCancel}>Cancel</button>
                    <button id="confirm-delete-btn" className="adminBtn adminBtn--danger" onClick={onConfirm}>Delete</button>
                </div>
            </div>
        </div>
    );
        ...
        <div className="adminModalBackdrop" onClick={onClose}>
            ...
            >
                <div className="adminModalHeader">
                    ...
                    <button id="product-modal-close" className="adminModalCloseBtn" onClick={onClose}>✕</button>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                        ...
                        >
                            {previewUrl ? (
                                <img
                                    src={previewUrl}
                                    alt="Product preview"
                                    style={{ width: 80, height: 80, objectFit: "contain", borderRadius: 8, background: "#fff" }}
                                />
                            ) : (
                                <div
                                    style={{
                                        width: 80, height: 80, borderRadius: 8, background: "#e2e8f0",
                                        display: "grid", placeItems: "center", fontSize: "1.8rem", flexShrink: 0,
                                    }}
                                >
                                    🖼️
                                </div>
                    ...
                    <div className="adminModalFooter">
                        <button id="product-modal-cancel" type="button" className="adminBtn adminBtn--ghost" onClick={onClose}>
                            Cancel
                        </button>
                        <button
    ...
    async function handleSave(formData) {
        ...
        try {
            ...
            if (formData.id) {
                ...
                setProducts((prev) =>
                    prev.map((p) => (p.id === formData.id ? { ...p, ...response } : p))
                );
                    ...
                    <div className="adminPanel">
                        ...
                        {loading ? (
                            ...
                            <div className="adminEmptyState">
                                <span>📦</span>
                                <p>No products found{search ? " for your search" : ""}</p>
                            </div>
                        ) : (
                                            ...
                                            <tr key={product.id}>
                                                <td>
                                                    <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                                                        ...
                                                        <div>
                                                            <div style={{ fontWeight: 600, fontSize: "0.875rem", maxWidth: 200 }}>
                                                                {product.name}
                                                            </div>
                                                ...
                                                <td style={{ fontWeight: 700, color: "#db4444" }}>
                                                    ${Number(product.price || 0).toFixed(2)}
                                                </td>
                                                <td style={{ color: "#94a3b8", textDecoration: "line-through", fontSize: "0.82rem" }}>
                                                ...
                                                <td>
                                                    <span
                                                        style={{
                                                            fontWeight: 600,
                                                            color: (product.stock ?? product.countInStock ?? 0) > 0 ? "#059669" : "#dc2626",
                                                        }}
                                                    >
