...
function RatingStars({ rating, reviews }) {
    return (
        <div className="productRatingRow" aria-label={`${rating} out of 5 stars`}>
...
export default function ProductDetailPage() {
        ...
        async function fetchData() {
            ...
            try {
                ...
                if (fetchedProduct.category) {
                    const { response: related } = await getProductsByCategory(fetchedProduct.category);
                    if (isMounted) {
    ...
    if (loading) {
        return <div className="appContainer" style={{ padding: '100px 0', textAlign: 'center' }}>Loading product details...</div>;
    }

    if (!product) {
        return <div className="appContainer" style={{ padding: '100px 0', textAlign: 'center' }}>Product not found.</div>;
    }
                ...
                <div className="productMainSection">
                    ...
                    <div className="productGallery">
                        <div className="productMainImageDisplay">
                            <img src={buildAssetUrl(activeImage)} alt={product.name} />
                        </div>
                    </div>
                    ...
                    <div className="productInfo">
                        ...
                        />
                        <h2 className="productPrice">{formatPrice(product.price)}</h2>
                        ...
                        <div className="deliveryInfoBox">
                            <div className="deliveryItem">
                                ...
                                <div className="deliveryItemContent">
                                    <h3 className="deliveryItemTitle">Free Delivery</h3>
                                    <p className="deliveryItemText"><u>Enter your postal code for Delivery Availability</u></p>
                                </div>
                            </div>
                            <div className="deliveryItem">
                                <div className="deliveryItemIcon">
                                ...
                                <div className="deliveryItemContent">
                                    <h3 className="deliveryItemTitle">Return Delivery</h3>
                                    <p className="deliveryItemText">Free 30 Days Delivery Returns. <u>Details</u></p>
                                </div>
                            </div>
                        </div>
                    </div>
